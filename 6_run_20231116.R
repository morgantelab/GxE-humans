...
#args <- c(14, 120, 103,  1100, 100, 10,   100, 6)
args
...
if(args[2]==1){
  ...
  rm(Xmat, Zmat, Emat, Gmat, EL2mat, Ee2mat); gc()
...
if(args[2]==8){
  ...
  ETA <- list(X=list(X=Xmat, model="FIXED", saveEffects=TRUE), 
   ...
   rm(Xmat, Zmat, Emat, Gmat, EL2mat, Ee2mat, GEEmat); gc()
...
if(args[2]==9){
  ...
  ETA <- list(X=list(X=Xmat, model="FIXED", saveEffects=TRUE), 
   ...
   rm(Xmat, Zmat, Emat, Gmat, EL2mat, Ee2mat, GEL2EL2mat); gc()
...
if(args[2]==10){
  ...
  ETA <- list(X=list(X=Xmat, model="FIXED", saveEffects=TRUE), 
   ...
   rm(Xmat, Zmat, Emat, Gmat, EL2mat, Ee2mat, GEe2Ee2mat); gc()
...
#    if(is.na(tapply(phen, Xmat[,i], sd)[1]) & is.na(tapply(phen, Xmat[,i], sd)[2])){
#      Xmat[,i] <- rbinom(nrow(Xmat),1,0.5)
#    }
#  }
