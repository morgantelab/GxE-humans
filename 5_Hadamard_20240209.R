...
if(args[2]==1){
	...
	save(dEE, file=paste("../datasets/d", args[1], "EE_20231010.RData", sep=''))
	save(eEE, file=paste("../datasets/e", args[1], "EE_20231010.RData", sep=''))
	write.table(eEE$values, paste("../datasets/e", args[1], "EE_values_20231010.txt", sep=''), col.names=F, row.names=F, quote=F)
...
if(args[3]==1){
	...
	EL2EL2[1:10,1:10]
	dEL2EL2 <- diag(EL2EL2)
	eEL2EL2 <- eigen(EL2EL2)
	eEL2EL2[["ids"]] <- dt$ID

	save(dEL2EL2, file=paste("../datasets/d", args[1], "EL2EL2_20231010.RData", sep=''))
	save(eEL2EL2, file=paste("../datasets/e", args[1], "EL2EL2_20231010.RData", sep=''))
	write.table(eEL2EL2$values, paste("../datasets/e", args[1], "EL2EL2_values_20231010.txt", sep=''), col.names=F, row.names=F, quote=F)
	...
	if(1==0){
		...
		rm(GEL2EL2, dGEL2EL2, eGEL2EL2)

	}

	rm(EL2mat, EL2EL2, wei, dEL2EL2, eEL2EL2)
...
if(args[4]==1){
	...
	Ee2Ee2[1:10,1:10]
	dEe2Ee2 <- diag(Ee2Ee2)
	eEe2Ee2 <- eigen(Ee2Ee2)
	eEe2Ee2[["ids"]] <- dt$ID

	save(dEe2Ee2, file=paste("../datasets/d", args[1], "Ee2Ee2_20231010.RData", sep=''))
	save(eEe2Ee2, file=paste("../datasets/e", args[1], "Ee2Ee2_20231010.RData", sep=''))
	write.table(eEe2Ee2$values, paste("../datasets/e", args[1], "Ee2Ee2_values_20231010.txt", sep=''), col.names=F, row.names=F, quote=F)
	...
	if(1==0){
		...
		rm(GEe2Ee2, dGEe2Ee2, eGEe2Ee2)

	}

	rm(Ee2mat, Ee2Ee2, wei, dEe2Ee2, eEe2Ee2)
