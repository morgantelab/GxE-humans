...
for(tr in c(10, 12, 14)){ # 
	...
	load(paste(paste(where, '_results/VCE_', tr, '_', mod, '_', subt, '.RData', sep='')))
	...
	png(filename=paste(where, "_traceplots/VCEtraceplot_", tr, '_model', mod, '_subset', subt, ".png", sep=""), height=800*P, width=4000,  bg="white")
...
for(tr in c(10, 12, 14)){ # 
	...
	if(tr>100){VCE <- VCE*100}
 	...
 	Res21[tr, 1] <- paste(round(mean(VCE$Vgen),2), " (", round(hpd1(VCE$Vgen),2), ", ", round(hpd2(VCE$Vgen),2), ")", sep='')
 	Res21[tr, 2] <- paste(round(mean(VCE$Venv),2), " (", round(hpd1(VCE$Venv),2), ", ", round(hpd2(VCE$Venv),2), ")", sep='')
 	Res21[tr, 3] <- paste(round(mean(VCE$Vdes),2), " (", round(hpd1(VCE$Vdes),2), ", ", round(hpd2(VCE$Vdes),2), ")", sep='')
 	Res21[tr, 4] <-  paste(round(mean(VCE$res),2), " (", round(hpd1(VCE$res),2),  ", ",  round(hpd2(VCE$res),2), ")", sep='')
 	Res21[tr, 5] <-  paste(round(mean(VCE$Vphen),2), " (", round(hpd1(VCE$Vphen),2),  ", ",  round(hpd2(VCE$Vphen),2), ")", sep='')
 	Res21[tr, 6] <-  paste(round(mean(VCE$Vgenenv),2), " (", round(hpd1(VCE$Vgenenv),2),  ", ",  round(hpd2(VCE$Vgenenv),2), ")", sep='')
  
 	res21[tr, 1] <- mean(VCE$Vgen)
	res21[tr, 2] <- mean(VCE$Venv)
 	res21[tr, 3] <- mean(VCE$Vdes)
  	res21[tr, 4] <- mean(VCE$res)
	res21[tr, 5] <- mean(VCE$Vphen)
	res21[tr, 6] <- mean(VCE$Vgenenv)
...
Res21 <- data.frame(trait=Yvars, model=21, Res21)
res21 <- data.frame(trait=Yvars, model=21, res21)
...
for(tr in c(10, 12, 14)){ # 
	...
	if(tr>100){VCE <- VCE*100}
 	...
 	Res22[tr, 1] <- paste(round(mean(VCE$Vgen),2), " (", round(hpd1(VCE$Vgen),2), ", ", round(hpd2(VCE$Vgen),2), ")", sep='')
 	Res22[tr, 2] <- paste(round(mean(VCE$Venv),2), " (", round(hpd1(VCE$Venv),2), ", ", round(hpd2(VCE$Venv),2), ")", sep='')
 	Res22[tr, 3] <- paste(round(mean(VCE$Vdes),2), " (", round(hpd1(VCE$Vdes),2), ", ", round(hpd2(VCE$Vdes),2), ")", sep='')
 	Res22[tr, 4] <-  paste(round(mean(VCE$res),2), " (", round(hpd1(VCE$res),2),  ", ",  round(hpd2(VCE$res),2), ")", sep='')
 	Res22[tr, 5] <-  paste(round(mean(VCE$Vphen),2), " (", round(hpd1(VCE$Vphen),2),  ", ",  round(hpd2(VCE$Vphen),2), ")", sep='')
 	Res22[tr, 6] <-  paste(round(mean(VCE$Vgenenv),2), " (", round(hpd1(VCE$Vgenenv),2),  ", ",  round(hpd2(VCE$Vgenenv),2), ")", sep='')
  
 	res22[tr, 1] <- mean(VCE$Vgen)
	res22[tr, 2] <- mean(VCE$Venv)
 	res22[tr, 3] <- mean(VCE$Vdes)
  	res22[tr, 4] <- mean(VCE$res)
	res22[tr, 5] <- mean(VCE$Vphen)
	res22[tr, 6] <- mean(VCE$Vgenenv)
...
Res22 <- data.frame(trait=Yvars, model=22, Res22)
res22 <- data.frame(trait=Yvars, model=22, res22)
...
for(tr in c(10, 12, 14)){
	...
	if(tr>100){VCE <- VCE*100}
 	...
 	Res32[tr, 1] <- paste(round(mean(VCE$Vgen),2), " (", round(hpd1(VCE$Vgen),2), ", ", round(hpd2(VCE$Vgen),2), ")", sep='')
 	Res32[tr, 2] <- paste(round(mean(VCE$Venv),2), " (", round(hpd1(VCE$Venv),2), ", ", round(hpd2(VCE$Venv),2), ")", sep='')
 	Res32[tr, 3] <- paste(round(mean(VCE$Vdes),2), " (", round(hpd1(VCE$Vdes),2), ", ", round(hpd2(VCE$Vdes),2), ")", sep='')
 	Res32[tr, 4] <-  paste(round(mean(VCE$res),2), " (", round(hpd1(VCE$res),2),  ", ",  round(hpd2(VCE$res),2), ")", sep='')
 	Res32[tr, 5] <-  paste(round(mean(VCE$Vphen),2), " (", round(hpd1(VCE$Vphen),2),  ", ",  round(hpd2(VCE$Vphen),2), ")", sep='')
  
 	res32[tr, 1] <- mean(VCE$Vgen)
	res32[tr, 2] <- mean(VCE$Venv)
 	res32[tr, 3] <- mean(VCE$Vdes)
  	res32[tr, 4] <- mean(VCE$res)
	res32[tr, 5] <- mean(VCE$Vphen)
...
Res32 <- data.frame(trait=Yvars, model=32, Res32)
res32 <- data.frame(trait=Yvars, model=32, res32)
...
for(tr in c(10, 12, 14)){ # 
	...
	if(tr>100){VCE <- VCE*100}
 	...
 	Res120[tr, 1] <- paste(round(mean(VCE$Vgen),2), " (", round(hpd1(VCE$Vgen),2), ", ", round(hpd2(VCE$Vgen),2), ")", sep='')
 	Res120[tr, 2] <- paste(round(mean(VCE$Venv),2), " (", round(hpd1(VCE$Venv),2), ", ", round(hpd2(VCE$Venv),2), ")", sep='')
 	Res120[tr, 3] <- paste(round(mean(VCE$Vdes),2), " (", round(hpd1(VCE$Vdes),2), ", ", round(hpd2(VCE$Vdes),2), ")", sep='')
 	Res120[tr, 4] <-  paste(round(mean(VCE$res),2), " (", round(hpd1(VCE$res),2),  ", ",  round(hpd2(VCE$res),2), ")", sep='')
 	Res120[tr, 5] <-  paste(round(mean(VCE$Vphen),2), " (", round(hpd1(VCE$Vphen),2),  ", ",  round(hpd2(VCE$Vphen),2), ")", sep='')
 	Res120[tr, 6] <-  paste(round(mean(VCE$Vgenenv),2), " (", round(hpd1(VCE$Vgenenv),2),  ", ",  round(hpd2(VCE$Vgenenv),2), ")", sep='')
  
 	res120[tr, 1] <- mean(VCE$Vgen)
	res120[tr, 2] <- mean(VCE$Venv)
 	res120[tr, 3] <- mean(VCE$Vdes)
  	res120[tr, 4] <- mean(VCE$res)
	res120[tr, 5] <- mean(VCE$Vphen)
	res120[tr, 6] <- mean(VCE$Vgenenv)
...
Res120 <- data.frame(trait=Yvars, model=120, Res120)
res120 <- data.frame(trait=Yvars, model=120, res120)
...
for(tr in c(10, 12, 14)){ # 
	...
	if(tr>100){VCE <- VCE*100}
 	...
 	Res132[tr, 1] <- paste(round(mean(VCE$Vgen),2), " (", round(hpd1(VCE$Vgen),2), ", ", round(hpd2(VCE$Vgen),2), ")", sep='')
 	Res132[tr, 2] <- paste(round(mean(VCE$Venv),2), " (", round(hpd1(VCE$Venv),2), ", ", round(hpd2(VCE$Venv),2), ")", sep='')
 	Res132[tr, 3] <- paste(round(mean(VCE$Vdes),2), " (", round(hpd1(VCE$Vdes),2), ", ", round(hpd2(VCE$Vdes),2), ")", sep='')
 	Res132[tr, 4] <-  paste(round(mean(VCE$res),2), " (", round(hpd1(VCE$res),2),  ", ",  round(hpd2(VCE$res),2), ")", sep='')
 	Res132[tr, 5] <-  paste(round(mean(VCE$Vphen),2), " (", round(hpd1(VCE$Vphen),2),  ", ",  round(hpd2(VCE$Vphen),2), ")", sep='')
 	Res132[tr, 6] <-  paste(round(mean(VCE$Vgenenv),2), " (", round(hpd1(VCE$Vgenenv),2),  ", ",  round(hpd2(VCE$Vgenenv),2), ")", sep='')
  
 	res132[tr, 1] <- mean(VCE$Vgen)
	res132[tr, 2] <- mean(VCE$Venv)
 	res132[tr, 3] <- mean(VCE$Vdes)
  	res132[tr, 4] <- mean(VCE$res)
	res132[tr, 5] <- mean(VCE$Vphen)
	res132[tr, 6] <- mean(VCE$Vgenenv)
...
Res132 <- data.frame(trait=Yvars, model=132, Res132)
res132 <- data.frame(trait=Yvars, model=132, res132)
...
Res <- smartbind(Res1, Res2, Res3, Res4, Res5, Res6, Res7, Res8, Res9, Res10, Res11, Res12, Res13, Res14, Res17, Res20, Res21, Res22, Res120, Res132) # , Res120
res <- smartbind(res1, res2, res3, res4, res5, res6, res7, res8, res9, res10, res11, res12, res13, res14, res17, res20, res21, res22, res120, res132) # 




write.table(Res, "ResultsCh_20240129.csv", col.names=T, row.names=F, sep=',')
write.table(res, "ResultsNu_20240129.csv", col.names=T, row.names=F, sep=',')
