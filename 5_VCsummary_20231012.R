...
Res <- smartbind(Res1, Res2, Res3, Res4, Res5, Res6, Res7, Res8, Res9, Res10, Res11, Res12, Res13, Res14, Res17, Res20, Res21, Res22)
res <- smartbind(res1, res2, res3, res4, res5, res6, res7, res8, res9, res10, res11, res12, res13, res14, res17, res20, res21, res22)




write.table(Res, "ResultsCh_20231026.csv", col.names=T, row.names=F, sep=',')
write.table(res, "ResultsNu_20231026.csv", col.names=T, row.names=F, sep=',')
