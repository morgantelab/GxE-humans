...
these <- c(1:which.min(abs(Val$sumval-50)))
...
save(dGEE, file="../datasets/dG50EE_20231010.RData")
save(eGEE, file="../datasets/eG50EE_20231010.RData")
write.table(eGEE$values, "../datasets/eG50EE_values_20231010.txt", col.names=F, row.names=F, quote=F)
...
save(dGEL2EL2, file="../datasets/dG50EL2EL2_20231010.RData")
save(eGEL2EL2, file="../datasets/eG50EL2EL2_20231010.RData")
write.table(eGEL2EL2$values, "../datasets/eG50EL2EL2_values_20231010.txt", col.names=F, row.names=F, quote=F)
...
save(dGEe2Ee2, file="../datasets/dG50Ee2Ee2_20231010.RData")
save(eGEe2Ee2, file="../datasets/eG50Ee2Ee2_20231010.RData")
write.table(eGEe2Ee2$values, "../datasets/eG50Ee2Ee2_values_20231010.txt", col.names=F, row.names=F, quote=F)
